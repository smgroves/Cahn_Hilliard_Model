...
int main()
{
    ...
    int nxc, nyc;
    double **uc_new, **wc_new, **uf_def, **wf_def;
    nxc = nx / 2;
    ...
    printf("prolong\n");
    prolong_ch(uc_new, uf_def, wc_new, wf_def, nxc, nyc);
    print_mat(uf_def, nx, ny);
    print_mat(wf_def, nx, ny);

    // make_oc_random(oc, nx, ny);
    // print_mat(oc, nx, ny);
    // prolong_ch(oc, uc_new, mu, wc_new, nxc, nyc);
    // print_mat(uc_new, nxc, nyc);
    // print_mat(wc_new, nxc, nyc);
