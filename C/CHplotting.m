...
% phi = readmatrix('/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/C/phi_CPC_update.m','FileType','text');
phi = readmatrix("/Users/smgroves/Documents/GitHub/pyCHSolver/outputs/phi_compare_to_C.txt");
phidims = size(phi);
...
myfig = figure();
% hold on
phi_movie = VideoWriter('/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/movie_outputs/phi_CPC_update_compare_to_C.mp4','MPEG-4');
