...
phi = readmatrix('/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/outputs/phi_CPC_from_file_128x128_100s_7max.m','FileType','text');
phidims = size(phi);
...
myfig = figure();
% hold on
phi_movie = VideoWriter('/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/movie_outputs/phi_CPC_from_file_128x128_100s_7max_constant_cbar.mp4','MPEG-4');
