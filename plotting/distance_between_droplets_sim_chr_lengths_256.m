...
% indir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/plotting/radii_over_time_level_set_plots/domain_0_2_noisy_cohesin_sd_0.11/";
indir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/plotting/radii_over_time_level_set_plots/domain_0_1_eps_0.0075/";
...
cohesin = "0.08";
eps = "0.0075";
chr_lengths = load("/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/plotting/image_analysis/chromosome_lengths.csv");
...
for CPC = ["0.1","0.12","0.125", "0.15", "0.22","0.25","0.3", "0.35"]
    ...
    midpoint = Nx/2;
    name = sprintf("phi_%d_19661_1.0e-5__CPC_%s_cohesin_%s_eps_%s_domain_0_1",Nx,CPC, cohesin, eps);
    ...
    for i = 1:num_chr
        ...
        fid = fopen('simulated_droplet_distances/simulated_droplet_distances_e_0.0075_domain_0_1_chr_lengths.csv', 'a+');
