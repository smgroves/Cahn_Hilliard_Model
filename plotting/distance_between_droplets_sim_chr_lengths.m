...
indir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/plotting/radii_lineplots_kymographs/domain_0_2_noisy_cohesin_sd_0.11_eps_0.008/";
...
% seed = "1111";
% for CPC = "0.12"
for CPC = ["0.1","0.12","0.125", "0.22","0.25","0.3", "0.35"]
    ...
    for i = 1:num_chr
        ...
        fid = fopen('simulated_droplet_distances_e_0.008_noisy_cohesin_chr_lengths.csv', 'a+');
