...
indir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/plotting/radii_lineplots_kymographs/domain_0_2_noisy_cohesin_sd_0.11_eps_0.0089/";
...
cohesin = "0.09";
epsilon = "0.0089";
chr_lengths = load("/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/plotting/image_analysis/chromosome_lengths_MCF10A.csv");
...
for CPC = ["0.1","0.12","0.125","0.15","0.173","0.2", "0.22","0.25","0.3", "0.35"]
    ...
    for i = 1:num_chr
        ...
        fid = fopen(sprintf('simulated_droplet_distances_e_%s_noisy_cohesin_chr_lengths_MCF10A.csv',epsilon), 'a+');
