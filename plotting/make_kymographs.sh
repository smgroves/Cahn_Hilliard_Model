...
do
    ...
    indir="/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/VCell_IC/$sim"
    dtout=10
    dt=2.5e-5
    for eps in 0.015009
    do
        ...
        do
            ...
            echo $name 
            outdir="/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/plotting/radii_over_time_level_set_plots/$sim/$name"
            echo $outdir
...
## error: '/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/VCell_IC/03_25_24_CPC_relaxed_RefModel_128x64_03_25_24_relaxed_RefModel_100_256x256_100s_8.4max/phi_256_2000_1.0e-5__eps_0.030019_alpha_-0.5.txt'.
...
echo $name 
outdir="/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/plotting/radii_over_time_level_set_plots/$name"
echo $outdir
...
# job array of double domain from rivanna
indir="/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/CPC_domain_0_2_alpha_-0.5_e_0.0075"
dtout=10
dt=0.000001525878906
nx=512
for CPC in 0.125 
