...
plt.tight_layout()
plt.savefig("/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/plotting/manuscript/figure_4/Free_energy.pdf")
plt.close()
...
sns.move_legend(ax, "upper left", bbox_to_anchor=(1, 1))
plt.tight_layout()
plt.savefig("/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/plotting/manuscript/figure_4/modified_free_energy.pdf")
plt.close()
