...
py_in_dir = "/Users/smgroves/Documents/GitHub/pyCHSolver"
#
...
long_compare = pd.read_csv(f"{py_in_dir}/Job_specs_all_py_c.csv", index_col = None, header = 0)
...
plt.tight_layout()
plt.savefig("../plots/min_py_c.pdf")
...
if True:
    ...
    plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    plt.tight_layout()
    plt.savefig("../plots/log_sec_all.pdf")
    ...
    plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    plt.tight_layout()
    plt.savefig("../plots/sec_c_jl.pdf")
