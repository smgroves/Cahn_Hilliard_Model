...
const xright = 128.0  # right x-coordinate defined as a global variable
const yleft = 0.0  # left y-coordinate defined as a global variable
const yright = 128.0  # right y-coordinate defined as a global variable
...
function multigrid_solver(oc, nx, tol, outdir; max_it=1000, max_it_CH=10000, suffix="", overwrite=true, print_phi=true, print_mass=false, print_e=false, print_r=true, dt=2.5e-5, m=8, ns=10, epsilon=0.01, check_dir=true)
    while true
        ny = nx
