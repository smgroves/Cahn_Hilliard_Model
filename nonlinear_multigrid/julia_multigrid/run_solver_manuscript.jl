...
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/droplet_R0_0.2_v3"
for dt in dts
    println(dt)
...
epsilon = m * (1 / 128) / (2 * sqrt(2) * atanh(0.9))
dts = [0.25 * dt_0, 0.5 * dt_0, dt_0, 2 * dt_0, 4 * dt_0]
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/spinodal_same_total_time"
total_time = 0.02
...
epsilon = m * (1 / 128) / (2 * sqrt(2) * atanh(0.9))
dts = [0.25 * dt_0, dt_0]
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/spinodal__same_total_time"
total_time = 0.002
phi = initialization_from_file("$outdir/phi_128_initial.txt", nx, nx, delim=' ')
for dt in dts
    println(dt)
...
epsilon = m * (1 / 128) / (2 * sqrt(2) * atanh(0.9))
dts = [0.25 * dt_0, dt_0]
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/spinodal_smoothed/smoothed_with_multigrid/"
total_time = 0.02
initial_time = 1
...
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/critical_radius_alpha"
for alpha in alphas
...
# alphas = [0.4]
phi = initialization(nx, nx, method="droplet", h=1 / 128, gam=epsilon)
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/critical_radius_alpha_v2"
for alpha in alphas
    time_passed = @elapsed main_w_alpha(phi, nx, tol, outdir, max_it=max_it, dt=dt, gam=epsilon, print_mass=true, print_e=true, overwrite=false, suffix="_alpha_$alpha", check_dir=false, alpha=alpha)
    open("/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/Job_specs.csv", "a", lock=false) do f
        writedlm(f, ["critical radius alpha" "Julia" nx epsilon dt tol max_it max_it_CH time_passed], ",")
...
for CPC_width in [10]
    ...
    outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry"
...
phi = initialize_round_CPC(nx, nx, CPC_width=CPC_width, cohesin_width=cohesin_width)
# phi = initialize_geometric_CPC(nx, ny; CPC_width=20, cohesin_width=4)
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry_grid_sizes"
...
ny = nx
factor = Int.(nx / 128)
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/CPC_alpha_-0.5"
...
ny = nx
factor = Int.(nx / 128)
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/CPC_alpha_0"
...
nx = 256
ny = nx
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/CPC_alpha_-0.2"
...
nx = 256
ny = nx
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/CPC_domain_0_2"
...
for file in ic_files
    ...
    for epsilon in [0.00375, 0.006, 0.0075, 0.015009, 0.030019]
        for alpha in [-0.5, -0.2, 0, 0.2] #in um: radius of CPC droplet
            ...
            outdir_prefix = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/CPC_geometry/VCell_IC"
...
for epsilon in [0.0096]
    for cohesin_width in [0.1] #in um: radius of CPC droplet, experimental = 0.2
