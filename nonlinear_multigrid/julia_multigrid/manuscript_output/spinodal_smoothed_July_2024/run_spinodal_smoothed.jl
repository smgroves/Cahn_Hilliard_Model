...
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/spinodal_smoothed/"
total_time = 0.02
...
m = 8
epsilon = m * (1 / 128) / (2 * sqrt(2) * atanh(0.9))
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/spinodal_smoothed/t_5"
total_time = 0.02
...
m = 8
epsilon = m * (1 / 128) / (2 * sqrt(2) * atanh(0.9))
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/spinodal_smoothed/t_500"
total_time = 0.02
phi = initialization_from_file("$outdir/SAV_smoothed_IC_time500_dt_6p25e-6.txt", nx, nx, delim=' ', transpose_matrix=true)
println(dt)
max_it = Int.(total_time / dt)
