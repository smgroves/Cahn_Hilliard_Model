...
outdir = "/Users/smgroves/Documents/GitHub/Cahn_Hilliard_Model/nonlinear_multigrid/julia_multigrid/manuscript_output/spinodal_smooth_relax_function/output_large_domain/"
...
# total_time = 0.01
total_time = (0.1 / 64^2) * 500 * 128^2
max_it = Int.(total_time / dt)
date_time = now()
name = "MG_$(max_it)_dt_$(dt)_Nx_$(nx)_n_relax_$(n_relax)_eps_$(epsilon)_large_domain"
