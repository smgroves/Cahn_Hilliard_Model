...
addOptional(ch_initialization_parser,'R0',default_R0,valid_fraction);
addOptional(ch_initialization_parser,'epsilon',default_epsilon,valid_pos_num);
addOptional(ch_initialization_parser,'W0',default_W0,valid_integer);
addOptional(ch_initialization_parser,'D0',default_D0,valid_integer);
addOptional(ch_initialization_parser,'initfile',default_initfile,valid_char);
addOptional(ch_initialization_parser,'chemstates',default_chemstates,valid_chemstate);
