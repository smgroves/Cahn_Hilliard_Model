...
ruf = uf_newf/dtf - nmg_laplace(wf_newf,nxf,nyf,xr,xl,yr,yl,bc);
rwf = wf_newf/dtf - uf_newf.^3 + epsilon2f*nmg_laplace(uf_newf,nxf,nyf,xr,xl,yr,yl,bc);
ruc = uc_newf/dtf - nmg_laplace(wc_newf,nxc,nyc,xr,xl,yr,yl,bc);
rwc = wc_newf/dtf - uc_newf.^3 + epsilon2f*nmg_laplace(uc_newf,nxc,nyc,xr,xl,yr,yl,bc);
ruf = suf-ruf;
rwf = swf-rwf;
