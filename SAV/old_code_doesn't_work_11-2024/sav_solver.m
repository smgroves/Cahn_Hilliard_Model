function [phi_new,r_new] = sav_solver(phi_old,phi_new,r_old,r_new,nx,ny,hx,hy,k2,k4, ...
...
%OUTPUT
    ...
    Lap_dfphi0 = Lap(phi0_df, k2);                    % Lap of df(phi0)
    phi_bar = A_inv_CN(phi0 + dt/2 * epsilon2 * Lap_dfphi0, dt, k2, k4, gamma0, epsilon2);

    % Step 1
    b = b_fun(phi_bar,hx,hy,C0,gamma0);
    g = g_fun_CN(phi0,r0,b,dt,hx,hy,epsilon2,gamma0,Beta,C0,k2);

    AiLb = A_inv_CN(epsilon2*Lap(b,k2),dt,k2,k4,gamma0,epsilon2);
