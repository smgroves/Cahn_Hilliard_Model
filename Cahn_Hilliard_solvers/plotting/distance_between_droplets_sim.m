...
for CPC = ["0.1","0.12","0.125", "0.15", "0.173", "0.2","0.22","0.25","0.3", "0.35"]
    ...
    Nx = 512;
    domain = 6.4;
    name = sprintf("phi_512_19661_1.0e-5__1234_CPC_%s_cohesin_%s_eps_%s_alpha_0_domain_0_2", CPC, cohesin, eps);
    ...
    for t = 1:num_timepoints
        ...
        if ismembertol(time, [sampled_times], 1e-3)
            ...
            fid = fopen('simulated_droplet_distances_e_0.0075_noisy_cohesin.csv', 'a+');
